package net.parkerstevens.imugrdemo.features.base
...
import net.parkerstevens.imgurdemo.injection.component.DaggerConfigPersistentComponent
import net.parkerstevens.imgurdemo.injection.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(ImgurApplication[activity as Context].component)
                    .build()
